...
PLS.ini.N <- function(x0.old,theta.old,beta.old,subid,data.path.u,obstime.u,N.u,h.u,knots.u,lambda1,tau=1){
...
z.tilde <- xderiv.a.N(N.u,h.u,theta.old,beta.old,knots.u,y.tilde)  ### gradient w.r.t. initial conditions a_il          ######### NEED UPDATE!!!############
...
PLS.theta.N <- function(x0.new,theta.old,beta.old,subid,data.path.u,obstime.u,N.u,h.u,knots.u,lambda2,tau=1){
###para: 
...
#####
y.tilde <- xpath.N(N.u,h.u,x0.new,theta.old,beta.old,knots.u)        ##  sample path evaluated at current estimates
v.tilde <- xderiv.theta.N(N.u,h.u,theta.old,beta.old,knots.u,y.tilde)                                ######### NEED UPDATE!!!############
...
LM.beta.N <- function(x0.new,theta.new,beta.old,subid,data.path.u,obstime.u,N.u,h.u,knots.u,lambda3,Phi.pen=NULL,tau=1){
...
##### evaluation at the current estimates 
y.tilde <- xpath.N(N.u,h.u,x0.new,theta.new,beta.old,knots.u)         ### sample path 
w.tilde <- xderiv.beta.N(N.u,h.u,theta.new,beta.old,knots.u,y.tilde)  ### gradient w.r.t. beta     ######### NEED UPDATE!!!############
...
FitLM.N<-function(x0.ini,theta.ini,beta.ini,subid,data.path.u,obstime.u,N.u,h.u,knots.u,lambda1.ini,lambda2.ini,lambda3.v,Phi.pen=NULL,adapt1=FALSE, adapt2=FALSE, ini.fix=FALSE, niter=10,thre=1e-3, conv.cri="beta",tau.v=matrix(1,3,niter)){
...
#####update theta
temp <- PLS.theta.N(x0.new,theta.ini,beta.ini,subid,data.path.u,obstime.u,N.u,h.u,knots.u,lambda2.ini,tau=tau.v[2,1])
theta.new<-temp[[1]]

#####update beta
temp <- LM.beta.N(x0.new,theta.new,beta.ini,subid,data.path.u,obstime.u,N.u,h.u,knots.u,lambda3.v[1],Phi.pen,tau=tau.v[3,1])
beta.new<-temp[[1]]
if(ini.fix==FALSE){
...
#####update theta
temp <- PLS.theta.N(x0.new,theta.new,beta.new,subid,data.path.u,obstime.u,N.u,h.u,knots.u,lambda2,tau=tau.v[2,count])
theta.new<-temp[[1]]
grad.T <- temp[[2]]


#####update beta
temp <- LM.beta.N(x0.new,theta.new,beta.new,subid,data.path.u,obstime.u,N.u,h.u,knots.u,lambda3.v[count],Phi.pen,tau=tau.v[3,count])
beta.new<-temp[[1]]
grad.beta <- temp[[2]] 
