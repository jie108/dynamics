...
NR.theta <- function(x0.old,theta.old,beta.old,subid,data.path.u,obstime.u,N.u,h.u,knots.u,lambda2.u,tau=1){
###para: 
...
######
  ...
  v.tilde <- xderiv.theta(N.u,h.u,theta.old,beta.old,knots.u,y.tilde)  ### gradient w.r.t. theta                   #####NEED UPDATE!!!!#####
  vv.tilde <- xHess.theta(N.u,h.u,theta.old,beta.old,knots.u,y.tilde,v.tilde) ### Hessian w.r.t. theta              #####NEED UPDATE!!!!#####  
...
NR.beta<- function(x0.old,theta.old,beta.old,subid,data.path.u,obstime.u,N.u,h.u,knots.u,Phi.pen=NULL,tau=1,NRadapt=FALSE,ncount=1,kstep=1,Hbeta.old=NULL){
...
#####
  y.tilde <- xpath(N.u,h.u,x0.old,theta.old,beta.old,knots.u)        ## sample path evaluated at current estimates
  w.tilde <- xderiv.beta(N.u,h.u,theta.old,beta.old,knots.u,y.tilde)       ## gradient w.r.t. beta                  #####UPDATE NEEDED!!!##########
...
if(NRadapt==FALSE  || ncount %% kstep == 1 || is.null(Hbeta.old)){
  ...
  ww.tilde <- xHess.beta(N.u,h.u,theta.old,beta.old,knots.u,y.tilde,w.tilde)     ### Hessian w.r.t. beta;           #####UPDATE NEEDED!!!##########
...
FitNR<-function(x0.ini,theta.ini,beta.ini,subid,data.path.u,obstime.u,N.u,h.u,knots.u,lambda1.ini,lambda2.ini,Phi.pen=NULL,adapt1=TRUE, adapt2=TRUE,ini.fix=FALSE,niter=10,thre=1e-3,conv.cri="grad",tau.v=matrix(1,3,niter),NRadapt=FALSE,kstep=1,Hbeta.old=NULL){
...
##### update theta
temp <-NR.theta(x0.new,theta.ini,beta.ini,subid,data.path.u,obstime.u,N.u,h.u,knots.u,lambda2.ini,tau=tau.v[2,1])
theta.new <- temp[[1]]

###update beta
temp <-NR.beta(x0.new,theta.new,beta.ini,subid,data.path.u,obstime.u,N.u,h.u,knots.u,Phi.pen,tau=tau.v[3,1],NRadapt,ncount=1,kstep,Hbeta.old)
...
##### update theta
temp <-NR.theta(x0.new,theta.new,beta.new,subid,data.path.u,obstime.u,N.u,h.u,knots.u,lambda2,tau=tau.v[2,count])
theta.new <- temp[[1]]
grad.T <- temp[[2]]


###update beta
temp <-NR.beta(x0.new,theta.new,beta.new,subid,data.path.u,obstime.u,N.u,h.u,knots.u,Phi.pen,tau=tau.v[3,count],NRadapt,ncount=count,kstep,Hbeta.old)
